...
| Numbers, Strings, Containers | Replace magic literals, avoid unnecessary allocations | [references/values-and-containers.md](references/values-and-containers.md) |
...
| Imports and Dependencies | Break cycles at module boundaries; local imports as a last resort | [references/imports-and-structure.md](references/imports-and-structure.md) |
